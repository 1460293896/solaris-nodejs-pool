...
#### Requirements
* Solaris Daemon and Wallet API
* [Node.js](http://nodejs.org/) v10.24.1
  * For Ubuntu: 
 ```
...
sudo apt-get install redis-server
 ```
* libssl and libsoldium required for the cryptonight-hashing module
  * For Ubuntu: `sudo apt-get install libssl-dev libsodium-dev`
...
```bash
git clone https://github.com/Solaris-Network/solaris-nodejs-pool.git pool
cd pool
...
```bash
curl 127.0.0.1:29001/json_rpc -d '{"method":"getblockheaderbyheight","params":{"height":100}}'
```
...
* [Kathtastic](//github.com/Kathtastic) - Adding useful features and maintaining to keep all resources online
